...
def main(args):
    ...
    search_results, rank_sum, total_rank = rank_search(model, tokenizer, model_id, 0.8, search_layer='o_proj') 
    model.model_fix_rank(search_results)
    #search_results, rank_sum, total_rank = rank_search(model, tokenizer, model_id, 0.6, search_layer='k_proj') 
    #model.model_fix_rank_key(search_results)
    ...
    for dataset in datasets:
        ...
        with open(f"results/Longbench/{raw_model_name}_bits_{args.lt_bits}.json", "a") as f:
            ...
            f.write("\n")
#default=["qmsum","multi_news","trec","lcc","repobench-p","triviaqa"]
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        default=["repobench-p","samsum","lcc","multi_news","qasper", "qmsum","triviaqa","trec"],
